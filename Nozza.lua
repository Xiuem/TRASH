...
local Tabs = {
    ...
    Raid = Window:AddTab({ Title = "Dungeon", Icon = "paintbrush-2" }),
    Race = Window:AddTab({ Title = "Race V4", Icon = "chevrons-right" }),
    Shop = Window:AddTab({ Title = "Shop", Icon = "shopping-cart" }),
	Misc = Window:AddTab({ Title = "Misc", Icon = "list-plus" }),
	About = Window: AddTab({ Title = "Onwer", Icon = "code-2" }),
	Qs= Window:AddTab({ Title = " Item/Quest", Icon = "swords" }),
}
...
ImageButton.Image = "rbxassetid://16132640635"
