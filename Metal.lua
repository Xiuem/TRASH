...
local Tabs = {
    ...
    De = Window:AddTab({ Title = " • BF & Raid", Icon = "" }),   
    Main= Window:AddTab({ Title = "Main", Icon = "home" }),    
    Rc = Window:AddTab({ Title = " • RaceV4", Icon = "" }),    
    Se = Window:AddTab({ Title = "Sea Event", Icon = "waves" }),    
    Lc = Window:AddTab({ Title = " • Local Player", Icon = "" }),   
    Qs= Window:AddTab({ Title = " Item/Quest", Icon = "paintbrush-2" }),
    About = Window: AddTab({ Title = " • Onwer", Icon = "" }),
}
...
local Slider = Tabs.Settings:AddSlider("Slider", {
  ...
  pcall(function()
   ...
   game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("PurchaseRawFruit",_G.SelectFruit)
    ...
    local Toggle = Tabs.De:AddToggle("MyToggle", {Title = "Tele Fruits[Tween]", Default = false })
...
local QuestBone =  CFrame.new(-9515.75, 174.8521728515625, 6079.40625)
        ...
        if _G.AutoBone then
            pcall(function()
                ...
                if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
                    if BypassTP then
                        wait()
                       if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - QuestBone.Position).Magnitude > 2500 then
                       BTP(QuestBone)
              
                       elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - QuestBone.Position).Magnitude < 2500 then
                ...
                if (QuestBone.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 3 then    
